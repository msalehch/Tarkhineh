    ...
    return (
        <div className="flex py-8 px-24 justify-between items-center" >
            ...
            <div className="flex gap-2">
                <Link to={'#'}>
                    <Button variant="NavBarBTN" size="sm" title="Search"><img src={SearchIcon} alt="SearchIcon" /></Button>
                </Link>
                <Link to={'#'}>
                    <Button variant="NavBarBTN" size="sm" title="User"><img src={UserIcon} alt="UserIcon" /></Button>
                </Link>
                <Link to={'#'}>
                    <Button variant="NavBarBTN" size="sm" title="Shop"><img src={ShoppingCartIcon} alt="ShoppingCartIcon" /></Button>
                </Link>
            </div>
        </div>
    )
